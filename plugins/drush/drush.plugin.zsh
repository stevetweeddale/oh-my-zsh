...
#
# The rest of this file is a port of the default bash behaviour supplied with
# drush in its example.bashrc
#
# This file can be overridden quite easily, should you wish to remove/alter any
# of the functionality, as it is fairly invasive. *washes hands*
#
...
#
# By default, aliases are also created (but no enabled) for the following standard
# commands:
#
#       cd                - cddl [*]
#       ls                - lsd
